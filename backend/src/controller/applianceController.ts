...
export default async function (fastify: FastifyInstance,) {
    // Heatpump WaterHeater:  https://electric-machines-h6x1.vercel.app/api/v1/appliance/appliance?applianceType=hpwh&capacityMin=40&capacityMax=60&uef=2.5&fhr=60
    // Heatpump Dryer:        https://electric-machines-h6x1.vercel.app/api/v1/appliance/appliance?applianceType=hpd&soundLevel=62&cef=7.0&capacityMin=6.0&capacityMax=7.0
